...
namespace GradeBook.GradeBooks
{
    public abstract class BaseGradeBook
    {
        ...
        public BaseGradeBook(string name, bool parameter)
        {
            Name = name;
            Students = new List<Student>();
            IsWeighted = parameter;
        }
        ...
        {
            int plus = 0;
            if (IsWeighted && (studentType == StudentType.Honors || studentType == StudentType.DualEnrolled)) { plus = 1; }
